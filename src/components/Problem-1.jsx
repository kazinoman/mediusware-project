...
const Problem1 = () => {
  ...
  const filteredTasks = useMemo(() => {
    ...
    const otherTasks = tasks.filter((task) => !status.includes(task.status));
    const finalTasks = activeTasks.concat(completedTasks).concat(otherTasks);
        ...
        <div className="col-6 ">
          <form className="row gy-2 gx-3 align-items-center mb-4" onSubmit={handleSubmit}>
            <div className="col-auto">
              <input type="text" className="form-control" placeholder="Name" name="task" />
            </div>
            <div className="col-auto">
